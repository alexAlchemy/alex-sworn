      ...
      <ion-content>
        <ion-list>
          <ion-menu-toggle :auto-hide="false">
            <ion-item button router-link="/" router-direction="root">
              <ion-label>Oracles</ion-label>
            </ion-item>
            ...
            <ion-item button router-link="/truths" router-direction="forward">
              <ion-label>World Truths</ion-label>
            </ion-item>
